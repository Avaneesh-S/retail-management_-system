...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.photo.setGeometry(QtCore.QRect(10, 50, 541, 361))
        self.photo.setText("")
        self.photo.setPixmap(QtGui.QPixmap("12th computer project/dog.jpg"))
        self.photo.setScaledContents(True)
        self.photo.setObjectName("photo")
        self.cat = QtWidgets.QPushButton(self.centralwidget)
        self.cat.setGeometry(QtCore.QRect(20, 430, 271, 31))
        self.cat.setObjectName("cat")
        self.dog = QtWidgets.QPushButton(self.centralwidget)
        self.dog.setGeometry(QtCore.QRect(294, 430, 281, 31))
    ...
    def show_cat(self):
        self.photo.setPixmap(QtGui.QPixmap("12th computer project/cat.jpg"))
